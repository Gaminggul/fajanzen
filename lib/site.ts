  ...
  de: {
    ...
    contact: {
      ...
      form: {
        ...
        messageRequired: "Bitte schreib kurz, worum es geht.",
        messageMinLength: "Die Nachricht sollte mindestens 10 Zeichen lang sein.",
        submitted: "E-Mail-Client wurde geöffnet — schick die E-Mail ab und ich melde mich!",
      },
    },
    footer: {
  ...
  en: {
    ...
    contact: {
      ...
      form: {
        ...
        messageMinLength: "The message should be at least 10 characters.",
        submitted: "Your email client has opened — just hit send and I'll get back to you!",
      },
    },
    footer: {
      copyright: "© 2026 Noel Janzen",
  ...
  ru: {
    ...
    contact: {
      ...
      form: {
        ...
        submitted: "Почтовый клиент открыт — отправьте письмо, и я отвечу!",
      },
    },
    footer: {
      copyright: "© 2026 Noel Janzen",
