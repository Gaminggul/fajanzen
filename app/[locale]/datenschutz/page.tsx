...
const NOTE: Record<string, string> = {
  en: "This privacy policy (Datenschutzerklärung) is required by German law and is provided in German.",
  ru: "Политика конфиденциальности (Datenschutzerklärung) обязательна по немецкому законодательству и предоставлена на немецком языке.",
};
